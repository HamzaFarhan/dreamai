...
def documents_upload(current_index: str, swap_oob: str | None = None):
    components = [
    ...
    if not current_index:
        ...
        components += [
            ...
            Form(
                ...
                Img(
                    src="SVG-Loaders-master/svg-loaders/ball-triangle.svg", cls="ui-indicator"
                ),
    ...
    return Div(*components, divider(), id="documents-upload", hx_swap_oob=swap_oob)


def questionnaire_upload(current_index: str, swap_oob: str | None = None):
    ...
    return Div(*components, divider(), id="questionnaire-upload", hx_swap_oob=swap_oob)
...
async def home(index: str = ""):
    ...
    container_components = [
        ...
        divider(),
        documents_upload(current_index=current_index),
        questionnaire_upload(current_index=current_index),
    ]
...
def select_index(index: str = ""):
    return (
        ...
        documents_upload(current_index=index, swap_oob="outerHTML"),
        questionnaire_upload(current_index=index, swap_oob="outerHTML"),
    )
