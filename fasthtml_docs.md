...
new_data = dict(email='jeremy@example.com', phone='7654321', age=25)
print(client.post("/profile", data=new_data).text)
```

Line 2  
We use the `Profile` dataclass definition to set the type for the
incoming `profile` content

Line 3  
We use
[`fill_form`](https://AnswerDotAI.github.io/fasthtml/api/components.html#fill_form)
to populate the form from the incoming `profile` dataclass

Line 6  
This is different cotnent from the previous dataclass used above.
     ...
     <html>
       <head>
         <title>Profile for jeremy@example.com</title>
       </head>
       <body>
         <main class="container">
           <h1>Profile for jeremy@example.com</h1>
           <form enctype="multipart/form-data" method="post" action="/profile">
             <fieldset>
               <label>
    Email
                 <input name="email" value="jeremy@example.com">
               </label>
               <label>
    Phone
...
&#10; <html>
   ...
   <body>
     <p>Set to 2024-09-01 17:14:23.295484</p>
   </body>
 </html>
...
```
    ...
    'Cookie was set at time 17:14:23.295510'
